...
3. Update Connection Details: The application uses the following default connection details. You must change these in HotelReservationSystem.java if your MySQL configuration is different.
